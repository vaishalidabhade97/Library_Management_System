...
public class searchByTitle extends JFrame {

	private JPanel contentPane;
	private JTable table;
	private JTextField textField;
    static searchByTitle frame;
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					frame = new searchByTitle();
	...
	public searchByTitle() {
		...
		JLabel delete = new JLabel("Search By Title");
		...
		btnSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(title==null||title.trim().equals("")){
					JOptionPane.showMessageDialog(searchByTitle.this,"Title can't be blank");
				}else{
					
					int i=ByTitleDao.search(title);
					if(i<=0)
						JOptionPane.showMessageDialog(searchByTitle.this,"Books not available");	
